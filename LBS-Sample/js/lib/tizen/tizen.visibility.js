 ...
 * 
 * tizen.visibility.onApplicationVisible(function() { console.log("app visible"); });
 * 
 ...
 */
/*
 * In case tizen.application is turn on in config.xml visibility module is in tizen.application.visibility namespace
 * 
 * tizen.application.visibility.onApplicationVisible(function() { console.log("app visible"); });
 * 
 * tizen.application.visibility.onApplicationHidden(function() { console.log("app hidden"); });
 */
