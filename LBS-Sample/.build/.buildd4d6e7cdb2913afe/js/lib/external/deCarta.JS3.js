...
deCarta.Touch = {
    ...
    // Tizen userAgen added in RegExp
    touchable: /Tizen|webos|bada|android|blackberry|fennec|ip(hone|od|ad)|maemo|opera mob|Kindle Fire|Silk/i.test(navigator.userAgent || navigator.vendor || window.opera),
...
deCarta.Core.EventableObject.prototype = {
	...
	touchOut: function(e, oe){				
		...
		this.triggerEvent('hoveroff', e, oe);
		this.hovered = false;
	},
    ...
    triggerEvent: function(which, e, oe){

		var eventPosition = this.owner.owner.positionFromXY(e.pageX, e.pageY);
        if (!this.checkEvent(e, eventPosition)) return;
 ...
 /*   createListenProps: function(){
    ...
    */
    ...
    init: function(){        
        ...
        this.addLayer(new deCarta.Core.MapLayer({
            name: 'Map View',
            visible: true,
...
deCarta.Core.SatelliteTileStore.prototype = {
    ...
    getTileUrl: function(x, y, z){
        ...
        if (deCarta.Core.Configuration.DGUrlVersion == 2 && 
        ...
        this.send(xmlRequest, function(res){
            ...
            try {
                if (typeof res.XLS.ResponseHeader.ErrorList === 'object'){
                    ...
                    deCarta.Core.Configuration.url = 'http://' + res.XLS.Response.RUOKResponse.hostName + '/openls/JSON';
